...
package blue3D.bulletphysics.collision.dispatch;

import blue3D.bulletphysics.BulletGlobals;
import blue3D.bulletphysics.BulletStats;
import blue3D.bulletphysics.collision.broadphase.BroadphaseInterface;
import blue3D.bulletphysics.collision.broadphase.BroadphaseNativeType;
import blue3D.bulletphysics.collision.broadphase.BroadphaseProxy;
import blue3D.bulletphysics.collision.broadphase.CollisionFilterGroups;
import blue3D.bulletphysics.collision.broadphase.Dispatcher;
import blue3D.bulletphysics.collision.broadphase.DispatcherInfo;
import blue3D.bulletphysics.collision.broadphase.OverlappingPairCache;
import blue3D.bulletphysics.collision.narrowphase.ConvexCast;
import blue3D.bulletphysics.collision.narrowphase.ConvexCast.CastResult;
import blue3D.bulletphysics.collision.narrowphase.GjkConvexCast;
import blue3D.bulletphysics.collision.narrowphase.GjkEpaPenetrationDepthSolver;
import blue3D.bulletphysics.collision.narrowphase.SubsimplexConvexCast;
import blue3D.bulletphysics.collision.narrowphase.TriangleConvexcastCallback;
import blue3D.bulletphysics.collision.narrowphase.TriangleRaycastCallback;
import blue3D.bulletphysics.collision.narrowphase.VoronoiSimplexSolver;
import blue3D.bulletphysics.collision.shapes.BvhTriangleMeshShape;
import blue3D.bulletphysics.collision.shapes.CollisionShape;
import blue3D.bulletphysics.collision.shapes.CompoundShape;
import blue3D.bulletphysics.collision.shapes.ConcaveShape;
import blue3D.bulletphysics.collision.shapes.ConvexShape;
import blue3D.bulletphysics.collision.shapes.SphereShape;
import blue3D.bulletphysics.collision.shapes.TriangleMeshShape;
import blue3D.bulletphysics.linearmath.AabbUtil2;
import blue3D.bulletphysics.linearmath.IDebugDraw;
import blue3D.bulletphysics.linearmath.Transform;
import blue3D.bulletphysics.linearmath.TransformUtil;
import blue3D.bulletphysics.linearmath.VectorUtil;
import blue3D.bulletphysics.util.ObjectArrayList;
//import cz.advel.stack.Stack;
import blue3D.type.Matrix3f;
...
public class CollisionWorld {
	...
	public void convexSweepTest(ConvexShape castShape, Transform convexFromWorld, Transform convexToWorld, ConvexResultCallback resultCallback) {
		...
		// Compute AABB that encompasses angular movement
		{
			...
			R.setIdentity();
			R.setRotation(convexFromTrans.getRotation(new QuaternionF()));
