...
package blue3D.bulletphysics.linearmath;
...
public class QuaternionUtil {
	...
	public static void setRotation(QuaternionF q, Vector3f axis, float angle) {
		float d = axis.length();
		assert (d != 0f);
	...
	public static QuaternionF shortestArcQuat(Vector3f v0, Vector3f v1, QuaternionF out) {
	...
	public static void mul(QuaternionF q, Vector3f w) {
	...
	public static Vector3f quatRotate(QuaternionF rotation, Vector3f v, Vector3f out) {
		QuaternionF q = new QuaternionF(rotation);
		QuaternionUtil.mul(q, v);

		QuaternionF tmp = new QuaternionF();
	...
	public static void inverse(QuaternionF q) {
		q.x = -q.x;
		q.y = -q.y;
		q.z = -q.z;
	}
	
	public static void inverse(QuaternionF q, QuaternionF src) {
		q.x = -src.x;
		q.y = -src.y;
		q.z = -src.z;
		q.w = src.w;
	...
	public static void setEuler(QuaternionF q, float yaw, float pitch, float roll) {
