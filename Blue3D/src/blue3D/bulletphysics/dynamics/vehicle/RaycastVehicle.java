...
package blue3D.bulletphysics.dynamics.vehicle;

import blue3D.bulletphysics.dynamics.RigidBody;
import blue3D.bulletphysics.dynamics.constraintsolver.ContactConstraint;
import blue3D.bulletphysics.dynamics.constraintsolver.TypedConstraint;
import blue3D.bulletphysics.dynamics.constraintsolver.TypedConstraintType;
import blue3D.bulletphysics.linearmath.MatrixUtil;
import blue3D.bulletphysics.linearmath.MiscUtil;
import blue3D.bulletphysics.linearmath.QuaternionUtil;
import blue3D.bulletphysics.linearmath.Transform;
import blue3D.bulletphysics.util.ArrayPool;
import blue3D.bulletphysics.util.FloatArrayList;
...
public class RaycastVehicle extends TypedConstraint {
	...
	public void updateWheelTransform(int wheelIndex, boolean interpolatedTransform) {
		...
		up.setNegation(wheel.raycastInfo.wheelDirectionWS);
		...
		QuaternionF steeringOrn = new QuaternionF();
		...
		QuaternionF rotatingOrn = new QuaternionF();
	...
	public void resetSuspension() {
		...
		for (i = 0; i < wheelInfo.size(); i++) {
			...
			wheel.raycastInfo.contactNormalWS.setNegation(wheel.raycastInfo.wheelDirectionWS);
