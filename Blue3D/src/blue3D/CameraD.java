...
import blue3D.type.baseEntities.BasicInstanceD;

public class CameraD extends BasicInstanceD implements Camera{
	 ...
	 */
	public CameraD(float near_plane, float far_plane, float fov, int width, int height){
	 ...
	 */
	CameraD(float near_plane, float far_plane, float fov, ViewPort viewPort){
	 ...
	 */
	public CameraD resize(int width, int height){
		//update width & height
		this.width=width;
		this.height=height;
	 ...
	 */
	public CameraD calculateMatrix(){
		//reset the matrix
