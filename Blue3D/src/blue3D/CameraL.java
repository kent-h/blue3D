...
public class CameraL extends BasicInstanceL implements Camera{
	 ...
	 */
	public CameraL(){
		nearPlane=100f;//0.01m
		farPlane=100000;//1000m
	 ...
	 */
	public CameraL(float near_plane, float far_plane, float fov, int width, int height){
	 ...
	 */
	CameraL(float near_plane, float far_plane, float fov, ViewPort viewPort){
...
//	}
	 ...
	 */
	public CameraL resize(int width, int height){
		//update width & height
	 ...
	 */
	public CameraL calculateMatrix(){
		//reset the matrix
